...
{
    public class SettingIconBorderModel : DefaultModel
    {
        public SettingIconBorderModel(Dictionary<string, string> config) : base(config)
        {
        ...
        {
            return new SettingIconBorderView();
        }
