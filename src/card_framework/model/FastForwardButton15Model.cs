...
{
    public class FastForwardButton15Model : DefaultModel
    {
        public FastForwardButton15Model(Dictionary<string, string> config) : base(config)
        {
        ...
        {
            return new FastForwardButton15View();
        }
